...
graph TD
    ...
    Scripts --> Updater[incremental_updater.py<br/><em>в разработке</em>]
...
| **2. Система ежедневного обновления** | 🚧 **В реализации** | Создаётся автоматический пайплайн |
| **3. Расчёт абсолютных курсов** | ⏳ В плане | Алгоритмическое ядро проекта |
| **4. Веб-интерфейс AbsCur3** | ⏳ В плане | Визуализация на GitHub Pages |

**Текущий фокус**: Завершение этапа 2 — создание надёжной системы поддержания актуальности данных.
